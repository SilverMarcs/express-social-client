...
const UserWidget = ({ userId, picturePath }) => {
  ...
  if (!user) {
    return null; // if user is null, return null. This is a guard clause. It prevents the rest of the code from running if the user is null.
  }
        ...
        <FlexBetween gap="1rem">
          ...
          <Box>
            <Typography
              ...
              sx={{
                "&:hover": {
                  color: palette.primary.light, // TODO change
                  cursor: "pointer",
                },
              }}
            >
